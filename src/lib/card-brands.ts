...
export const CARD_BRANDS = [
  ...
  },
  {
    value: 'hipercard',
    label: 'Hipercard',
    icon: `<svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="#D81C1C"><path d="M11.95 24l-.195-.002-9.37-8.156L2.31 4.053 11.83.187l9.734 11.72-9.615 12.092zm-.203-1.442L20.08 11.84 11.93 2.11 3.597 12.01l8.15 6.545z"/><path d="M12 12.007a.64.64 0 0 1-.64-.64V7.57a.64.64 0 1 1 1.28 0v3.796a.64.64 0 0 1-.64.64zm-.008 3.865a.86.86 0 0 1-.86-.86.86.86 0 0 1 .86-.86.86.86 0 0 1 .86.86.86.86 0 0 1-.86.86z"/></svg>`
  },
  {
    value: 'diners',
    label: 'Diners Club',
    icon: `<svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><circle cx="12" cy="12" r="12" fill="#0055A0"/><path d="M12 3a9 9 0 0 0-6.924 14.774A9.003 9.003 0 0 0 12 21a9 9 0 0 0 6.924-14.774A8.997 8.997 0 0 0 12 3Z" fill="#fff"/></svg>`
  },
  {
    value: 'discover',
    label: 'Discover',
    icon: `<svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><circle cx="12" cy="12" r="11" fill="#FF6000"/><path d="M12 20a8 8 0 0 1-3.33-15.35A8 8 0 0 0 12 4a8 8 0 0 1 8 8 8 8 0 0 1-8 8Z" fill="#fff"/></svg>`
  },
  {
    value: 'jcb',
    label: 'JCB',
    icon: `<svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path fill="#0055A0" d="M9.8 14l-1.4-2c-.1-.1-.2-.2-.3-.2H7.4v2.2H5.6V9.8h2.3c.9 0 1.5.6 1.5 1.3 0 .6-.3 1-.8 1.2l1.8 2.7zM8.3 11.2h.8c.4 0 .6-.2.6-.5s-.2-.5-.6-.5h-.8zm7.9 2.8l-1.4-2c-.1-.1-.2-.2-.3-.2h-.7v2.2h-1.8V9.8h2.3c.9 0 1.5.6 1.5 1.3 0 .6-.3 1-.8 1.2l1.8 2.7zM16.2 11.2h.8c.4 0 .6-.2.6-.5s-.2-.5-.6-.5h-.8z"/><path fill="#D81C1C" d="M5.2 14V9.8h-2V14zm5.4 0V9.8h-2V14zm5.4 0V9.8h-2V14z"/></svg>`
  },
  {
    value: 'aura',
    label: 'Aura',
    icon: `<svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="m18.42 22.8-6.41-6.42-6.42 6.42L.78 18.01l6.42-6.42L.78 5.18 5.58.39l6.42 6.41L18.42.39l4.79 4.79-6.41 6.42 6.41 6.41-4.8 4.79Z" fill="#FF8300"/></svg>`
  },
];
